...
static
void
phFriNfc_Desf_HWrapISONativeCmds(
    _Inout_ phFriNfc_sNdefSmtCrdFmt_t   *NdefSmtCrdFmt,
    _In_    uint8_t                     CmdType
    );
    ...
    )
{
    ...
    (void)phOsalNfc_SetMemory((void *)NdefSmtCrdFmt->AddInfo.Type4Info.PICCMasterKey,
                0x00, 16);

    (void)phOsalNfc_SetMemory((void *)NdefSmtCrdFmt->AddInfo.Type4Info.NFCForumMasterkey,
                0x00, 16);
    ...
    switch(CmdType)
    {
        ...
        case PH_FRINFC_DESF_CREATEAPP_CMD:
        {
            ...
            if (DESFIRE_CARD_TYPE_EV1 == NdefSmtCrdFmt->CardType)
            {
                ...
                i++;
                /* DF file name */
                (void)phOsalNfc_MemCopy((void *)&NdefSmtCrdFmt->SendRecvBuf[i],
        ...
        case PH_FRINFC_DESF_WRITENDEF_CMD:
        {
            ...
            (void)phOsalNfc_MemCopy(&NdefSmtCrdFmt->SendRecvBuf[i],
    ...
    )
{
        ...
        NdefSmtCrdFmt->SendRecvBuf[(*NdefSmtCrdFmt->SendRecvLength - 1)]))
    {
        ...
        phOsalNfc_MemCopy ((void *)read_cc_btyes, (void *)NdefSmtCrdFmt->SendRecvBuf,
