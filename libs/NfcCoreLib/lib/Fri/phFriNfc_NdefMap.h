...
#define PH_FRINFC_NDEFMAP_FELICA_SMART_CARD               3 /**< \internal Felica Smart Tag */
#define PH_FRINFC_NDEFMAP_TOPAZ_CARD                      4 /**< \internal Felica Smart Tag */
#define PH_FRINFC_NDEFMAP_TOPAZ_DYNAMIC_CARD              5 /**< \internal Felica Smart Tag */
#ifdef DESFIRE_EV1
#define PH_FRINFC_NDEFMAP_ISO14443_4A_CARD_EV1            6 /**< \internal Iso 14443-4A EV1 */
#endif /* #ifdef DESFIRE_EV1 */
#define PH_FRINFC_NDEFMAP_MIFARE_STD_1K_CARD              7 /**< \internal Mifare Standard */
#define PH_FRINFC_NDEFMAP_MIFARE_STD_4K_CARD              8 /**< \internal Mifare Standard */

#define PH_FRINFC_NDEFMAP_ISO15693_CARD                   9 /**< \internal ISO 15693 */
#define PH_FRINFC_NDEFMAP_MIFARE_ULC_CARD                 10 /**< \internal Mifare UL */
...
#define PH_FRINFC_NDEFMAP_TOPAZ_MAX_SIZE                255 /**< \internal Total Memory size = 96 bytes (newer version have mode) */
...
#define PH_FRINFC_NDEFMAP_FELICA_BLOCK_SIZE               16    /**<Block size of Felica*/
#define PH_FRINFC_NDEFMAP_FELICA_ATTR_NDEF_DATA_LEN        3    /**<Felica ATTR length*/
#define PH_FRINFC_NDEFMAP_FELICA_MANUF_ID_DATA_LEN         8    /**<Felica manufacturer ID length*/
...
typedef struct phFriNfc_Felica_PollDetails
{
    ...
    phNfc_sRemoteDevInformation_t   psTempRemoteDevInfo;
...
typedef struct phFriNfc_MifareStdCont
{
    ...
    uint8_t             internalBuf[PH_FRINFC_NDEFMAP_MIFARESTD_ST15_BYTES + 1];
...
typedef struct phFriNfc_TopazCont
{
    ...
    _Field_range_(<=, PH_FRINFC_NDEFMAP_TOPAZ_MAX_SIZE)
...
typedef struct phFriNfc_NdefMap
{
    ...
    phNfc_sDepAdditionalInfo_t      psDepAdditionalInfo;
    ...
    _Field_size_(_Inexpressible_("Size is ApduBufferSize, but indexes into the buffer are often complicated expressions that are hard to validate."))
    uint8_t                         *ApduBuffer;
    ...
    /**<\internal Holds the ack of some initial commands*/
    uint8_t                         *SendRecvBuf;
    ...
    /**< \ internal Holds the previous read mode*/
    uint8_t                         bPrevReadMode;

    /**< \ internal Holds the current read mode*/
    ...
    /** \internal Topaz capability container structure. */
 ...
 *                    called function).
 *
 * \note For general information about the completion routine interface please see \ref
 * pphFriNfc_Cr_t . * The Different Status Values are as follows
 *
 */
