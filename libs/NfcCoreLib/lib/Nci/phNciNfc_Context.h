...
typedef struct phNciNfc_Context
{
    ...
    pphNciNfc_IfNotificationCb_t ModeSetCallback;  /**<Pointer to upper layer call back function for ModeSet*/
    void *ModeSetCallbackContext;                      /**<Pointer to upper layer context for ModeSet*/
