...
enum NFCCX_LIBNFC_MESSAGE : UINT32
{
...
static_assert(LIBNFC_MESSAGE_MAX < PH_OSALNFC_MESSAGE_BASE, "NFCCX_LIBNFC_MESSAGE has too many values.");

enum NFCCX_RF_OPERATION : UINT32
{
    NFCCX_RF_OP_INIT,
    NFCCX_RF_OP_DEINIT,
    NFCCX_RF_OP_DISCOVER_CONFIG,
    NFCCX_RF_OP_DISCOVER_STOP,
    NFCCX_RF_OP_TAG_WRITE,
    NFCCX_RF_OP_TAG_CONVERT_READONLY,
    NFCCX_RF_OP_TARGET_ACTIVATE,
    NFCCX_RF_OP_TARGET_DEACTIVATE_SLEEP,
    NFCCX_RF_OP_TARGET_PRESENCE_CHECK,
    NFCCX_RF_OP_TARGET_TRANSCEIVE,
    NFCCX_RF_OP_TARGET_SEND,
    NFCCX_RF_OP_SE_ENUMERATE,
    NFCCX_RF_OP_SE_SET_MODE,
    NFCCX_RF_OP_SE_SET_ROUTING_TABLE,
    NFCCX_RF_OP_SNEP_CLIENT_PUT,
    NFCCX_RF_OP_EMEBEDDED_SE_TRANSCEIVE,
    NFCCX_RF_OP_EMBEDDED_SE_RESET,
};
